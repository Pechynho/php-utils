...
class ParamsChecker
{
	 ...
	 */
	public static function type($parameter, &$value, $type, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		if (!is_string($type)) {
			throw self::createException('$type', sprintf("Parameter {parameter} is expected to be a string. Value passed to {parameter}: %s", print_r($type, true)), __METHOD__);
		}
		if (!is_string($methodOrFunction) && $methodOrFunction != null) {
			throw self::createException('$methodOrFunction', sprintf("Parameter {parameter} is expected to be a string or a NULL. Value passed to {parameter}: %s", print_r($methodOrFunction, true)), __METHOD__);
		}
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function notWhiteSpaceOrNullString($parameter, $value, $methodOrFunction = null)
	{
	 ...
	 */
	private static function createException($parameter, $message, $methodOrFunction = null)
	{
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function isInstanceOf($parameter, $value, $class, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function classExists($parameter, $value, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		self::notWhiteSpaceOrNullString('$value', $value, __METHOD__);
		if (!is_string($methodOrFunction) && $methodOrFunction != null) {
			throw self::createException('$methodOrFunction', sprintf("Parameter {parameter} is expected to be a string or a NULL. Value passed to {parameter}: %s", print_r($methodOrFunction, true)), __METHOD__);
		}
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function notEmpty($parameter, $value, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		self::isStringOrNull('$methodOrFunction', $methodOrFunction, __METHOD__);
		if (empty($value)) {
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function types($parameter, &$value, array $types, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function count($parameter, $value, $minCount, $maxCount, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		if (!Arrays::isIterable($value)) {
			throw self::createException('$value', 'Parameter {parameter} is expected to be iterable (array or instance of Traversable). Values passed to {parameter}: ' . print_r($value, true), __METHOD__);
		}
		self::isIntOrNull('$minCount', $minCount, __METHOD__);
		self::isIntOrNull('$maxCount', $maxCount, __METHOD__);
		self::isStringOrNull('$methodOrFunction', $methodOrFunction, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function length($parameter, $value, $minLength, $maxLength, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		self::isString('$value', $value, __METHOD__);
		self::isIntOrNull('$minLength', $minLength, __METHOD__);
		self::isIntOrNull('$maxLength', $maxLength, __METHOD__);
		self::isStringOrNull('$methodOrFunction', $methodOrFunction, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function range($parameter, $value, $minValue, $maxValue, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function inArray($parameter, $value, array $values, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		self::isStringOrNull('$methodOrFunction', $methodOrFunction, __METHOD__);
	 ...
	 * @param string|null $methodOrFunction
	 */
	public static function notInArray($parameter, $value, array $values, $methodOrFunction = null)
	{
		self::notWhiteSpaceOrNullString('$parameter', $parameter, __METHOD__);
		self::isStringOrNull('$methodOrFunction', $methodOrFunction, __METHOD__);
		if (in_array($value, $values, true)) {
